...
```javascript
// Basic Information
valentineName: "Hoi Lam Wong"                    // Your Valentine's name
...
music: {
    enabled: true,
    autoplay: true,
    musicUrl: "https://res.cloudinary.com/dbgxpst7o/video/upload/v1739445425/npdrtqhpnrzfvq79wnyn.mp3", // Paste your URL here
